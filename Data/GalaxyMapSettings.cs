...
public static class GalaxyMapSettings
{
    public const double Width = 8000;
    public const double Height = 5000;
    public const double CenterX = 4000;
    public const double CenterY = 2500;
